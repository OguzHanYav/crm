          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Firma"
                className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 placeholder:text-slate-400 focus:border-slate-400 focus:outline-none"
              />
            </div>
